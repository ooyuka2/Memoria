...
function tree_menu(id, top, pre, child, wait, whatdotoday, todofile) {
	...
	if(pre!=100) { //child == 0 && 
		menu = menu + "<div class='btn-group' role='group'><button type='button' class='btn btn-default dropdown-toggle btn-xs btn-sm btn-block' data-toggle='dropdown' aria-expanded='false' aria-haspopup='true' >作業設定<span class='caret'></span></button><ul class='dropdown-menu' role='menu'>";
