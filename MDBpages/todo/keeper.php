...
<div class="card col-xl-12">
	<div class="card-body">
		...
		?>
			<div class='clearfix'>
				<button style='margin:10px 0' class='btn btn-default pull-right btn-sm' onClick='location.href = "/Memoria/MDBpages/todo.php?page=keeper&day=all"'>すべて</button>
				<button style='margin:10px 10px' class='btn btn-default pull-right btn-sm' onClick='location.href = "/Memoria/MDBpages/todo.php?page=keeper&day=31"'>31日間</button>
				<button style='margin:10px 10px' class='btn btn-default pull-right btn-sm' onClick='location.href = "/Memoria/MDBpages/todo.php?page=keeper&day=7"'>7日間</button>
				<button style='margin:10px 0' class='btn btn-default pull-right btn-sm' onClick='location.href = "/Memoria/MDBpages/todo.php?page=keeper&day=old201804working"'>201804まで</button>
			</div>
...
<?php
	...
	//echo $working[($i+1)]['startTime']. ":::". $lastTime."<br>";echo $interval->modify('+1 days')->format('%R%d日 %H時%i分');
