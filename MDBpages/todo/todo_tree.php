        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="md-form mb-5">
                    ...
                    <a type="button" class="btn btn btn-amber waves-effect">この日に頑張る <i class="fa fa-paper-plane-o ml-1"></i></a>
                    <a type="button" class="btn btn btn-amber waves-effect">そのうち頑張る <i class="fa fa-paper-plane-o ml-1"></i></a>
