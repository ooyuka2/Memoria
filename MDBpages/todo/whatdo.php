...
<?php
		...
		echo "</div></div><div class='row'><div class='form-group col-sm-9'><textarea class='form-control input-normal input-sm' name='note' id='note'>{$todo[$_GET['p']]['所感']}</textarea></div></div>";
	} else echo "</div><div class='row'><div class='form-group  col-sm-9'><textarea class='form-control input-normal input-sm' name='note' placeholder='{$todo[$_GET['p']]['所感']}' id='note'></textarea></div></div>";
?>
	<div class='row'>
	<div class='form-group col-sm-4'>
