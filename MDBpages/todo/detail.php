...
//			if($todo[$todoid]['parent']==$todoid && $todo[$todoid]['削除']==0) {
				if($todo[$todoid]['level']==1) echo "<div class='card border-primary'>";
				else if($todo[$todoid]['完了']==1) { echo "<div class='card border-success'>"; }
				else echo "<div class='card border-danger'>";
				...
				echo "<div class='col-9'><div class='progress'><div class='progress-bar progress-bar-info progress-bar-striped active' role='progressbar' style='width: {$todo[$todoid]['パーセンテージ']}%;'>";
				...
				if($todo[$todoid]['パーセンテージ']!=100) {
					...
					if($todo[$todoid]['保留'] == 0) echo "<div class='col-1'><a href='todo.php?page=wait&p={$todoid}&file={$file}' class='btn btn-info btn-sm'>保留</a></div>";
					else echo "<div class='col-1'><a href='todo.php?page=wait&p={$todoid}&file={$file}' class='btn btn-link btn-sm'>解除</a></div>";
					...
					echo "<div class='col-md-1 pull-right'><a href='./todo/nofinish.php?p={$todoid}' class='btn btn-warning btn-sm'>未完了</a></div>";
				}
