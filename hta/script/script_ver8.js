...
function tdlampString(i) {
	...
	var td_String = "<td class='situation'><button type='button' class='btn btn-situation btn-block btn-xs' id='preventbtm_"
...
function tdString(i) {
	var td_String = "<td class='situation txtcenter'>" + list[i]['createTime']
		...
		+ list[i]['fileId']+"' onClick=\"prevent('" + list[i]['fileName'] + "','" + list[i]['situation'] + "')\">進捗</button></td>"
		*/
		+ "<td class='situation'><button type='button'  class='btn btn-default btn-block btn-xs' disabled>-</button></td><td class='situation'>" + list[i]['situationDate'] + "</td>";
