			      ...
			      <div class="well bs-component">
			        <div class="form-group" style="margin-bottom:0;">
			            ...
			            <div class="col-xs-5" style="padding-right:0; padding-left:0;">
			                <input type="text" class="form-control input-normal input-sm" id="name" name="name" placeholder="メモ" onBlur="check_furi()">
			            </div>
			            <div class="col-xs-5" style="padding-left:0;">
			                <input type="text" class="form-control input-normal input-sm" id="furi" name="furi" placeholder="ふりがな">
			            </div>
			        </div>
			        <div class="form-group" style="margin-bottom:0;">
			            <div class="col-xs-12">
			        ...
			        <div class="form-group" style="margin-bottom:0;">
			            <div class="col-xs-12">
			                <textarea class="form-control input-normal input-sm" rows="4" id="textArea" name="detail"></textarea>
			            </div>
			        </div>
			    </div>
		        <div class="form-group" style="margin-bottom:0;">
