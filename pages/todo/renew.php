		            ...
		            <div class="col-xs-8">
						...
						<div class="col-xs-12" style="margin-bottom:5px">
							<?php
								...
								$id=count($todo);
								echo "<input type='hidden' name='id[]' value='$id' id='id0'>";
							?>
						</div>
						<div class="col-xs-12" style="margin-bottom:5px">
