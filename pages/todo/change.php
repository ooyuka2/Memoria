<?php
	...
	if(!isset($_GET['p'])) { // || $todo[$_GET['p']]['level']!=1
			...
			<div class="well bs-component">
		        <div class="form-group">
		            ...
		            <div class="col-xs-4">
						...
						<?php
							$today=date('Y-m-d');
							echo "<input type='date' class='form-control input-normal input-sm noki' name='noki[]' value='{$todo[$_GET['p']]['納期']}'>";
						?>
						</div>
						<div class="col-xs-12" style="margin-bottom:5px">
						...
						<div class="col-xs-12" style="margin-bottom:5px">
							...
							<?php echo "<input type='date' class='form-control input-normal input-sm kaisi' name='kaisi[]' value='{$todo[$_GET['p']]['開始予定日']}'>"; ?>
						</div>
						<div class="col-xs-12" style="margin-bottom:5px">
							<label class="control-label">終了予定日時</label>
							<?php echo "<input type='date' class='form-control input-normal input-sm syuryo' name='syuryo[]' value='{$todo[$_GET['p']]['終了予定日']}'>"; ?>
						</div>
		            </div>
		        </div>
			</div>
