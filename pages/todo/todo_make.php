...
?>
	...
	<fieldset style='position: relative' draggable='true'>
		<div class="well bs-component">
			<div class="form-group">
				...
				?>
					...
					<div class="col-xs-12" style="margin-bottom:5px">
						<textarea class="form-control input-normal input-sm detail" rows="3" name="detail[]"><?php echo $detail; ?></textarea>
					</div>
					<div class="col-xs-12" style="margin-bottom:5px">
						<?php echo "<input type='text' class='form-control input-normal input-sm mono' name='mono[]' placeholder='成果物' value='{$mono}'>"; ?>
					</div>
					<div class="col-xs-2 center-block" style="margin-bottom:5px"><button type='button' class='btn btn-warning btn-xs' onClick='level_up(this)'>▲</button><button type='button' class='btn btn-warning btn-xs eee' onClick='level_down(this)'>▼</button></div>
					...
					<div class="col-xs-3" style="margin-bottom:5px">
						...
						//else echo "<input type='number' class='form-control input-normal input-sm level' name='level[]' min='1' max='10' value='{$level}' onChange='change_level()'>";
						?>
					</div>
					<label class="col-sm-2 control-label" style="margin-bottom:5px">優先度</label>
					<div class="col-xs-3" style="margin-bottom:5px">
						<?php echo "<input type='number' class='form-control input-normal input-sm priority' name='priority[]' value='{$priority}' min='1' max='10'>"; ?>
					</div>
				</div>
				<div class="col-xs-4 date_and_time">
					...
					<div class="col-xs-12 " style="margin-bottom:5px">
						...
						<?php echo "<input type='time' class='form-control input-normal input-sm time' name='time[]' value='{$noki_time}' step='900'>"; ?>
					</div>
					<div class="col-xs-12" style="margin-bottom:5px">
						<label class="control-label">開始予定時刻</label>
						<?php echo "<input type='text' class='form-control input-normal input-sm kaisi' name='kaisi[]' value='{$kaisi}'>"; ?>
					</div>
					<div class="col-xs-12" style="margin-bottom:5px">
						<label class="control-label">終了予定日時</label>
						<?php echo "<input type='text' class='form-control input-normal input-sm syuryo' name='syuryo[]' value='{$syuryo}'>"; ?>
					</div>
	            </div>
	        </div>
		</div>
