...
function todo_fieldset($todo, $todo_theme, $todo_keeper_theme, $level, $type, $id, $p, $count, $weekly) {
	...
	echo "<div class='col-xs-2 center-block' style='margin-bottom:5px'><button type='button' class='btn btn-warning btn-xs' onClick='level_down(this)'>▲</button><button type='button' class='btn btn-warning btn-xs eee' onClick='level_up(this)'>▼</button></div>";
